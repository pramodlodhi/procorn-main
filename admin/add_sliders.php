                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-lg-4 col-md-4 col-12">
                                        ...
                                        <input type="file" class="form-control" accept="image/*" name="sliderImg" required>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-12">
                                        <label for="">Button Text <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" name="btnText" placeholder="Enter Button Text">
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-12">
                                        <label for="">Button Link <span class="text-danger"></span></label>
                                        <input type="text" class="form-control" name="btnLink" placeholder="Enter Button Link">
                                    </div>
                                    <div class="form-group col-lg-12 col-md-12 col-12">
                                        <label for="">Slider Content<span class="text-danger"></span></label>
                                        <textarea class="form-control" id="editor" rows="5" name="sliderText"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 d-flex" style="margin: auto;">
                                        ...
                                        <button type="submit" name="submit" class="btn btn-info btn-block" value="addHomeSlider">Submit</button>
                                    </div>
                                    <div class="col-md-3">
                                    </div>
                                </div>
